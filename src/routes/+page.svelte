<script>
	import { breakpointHandler, windowWidth } from 'jdg-ui-svelte';
	...
	import ProductCodeLabel from '$lib/components/ProductCodeLabel.svelte';
	...
	<JDGContentBoxFloating animateWhenVisible={false}>
		<JDGGridLayout>
			<JDGImageTile
				...
				imageMeta={imageMetaRegistry.products.CITYSCAPE_021A_0}
			...
			<JDGImageTile
				...
				imageMeta={imageMetaRegistry.products.DECOR_030A_0}
			...
			<JDGImageTile
				...
				imageMeta={imageMetaRegistry.products.PLANTER_003F_0}
			...
			<JDGImageTile
				...
				imageMeta={imageMetaRegistry.products.PEN_HOLDER_008I_0}
			...
			<JDGImageTile
				...
				imageMeta={imageMetaRegistry.products.CARD_HOLDER_015C_0}
			...
			<JDGImageTile
				...
				imageMeta={imageMetaRegistry.products.MAGNET_DEN_CO_047BC_0}
			...
			<JDGImageTile
				...
				imageMeta={imageMetaRegistry.products.MAGNET_CO_TOPO_047D_0}
				href={pageMeta.products.MAGNET_047.href +
					'#' +
			...
			<JDGImageTile
				...
				imageMeta={imageMetaRegistry.products.GRINDER_039A_0}
			...
			<JDGImageTile
				...
				imageMeta={imageMetaRegistry.products.COASTER_028A_0}
			...
			<JDGImageTile
				...
				imageMeta={imageMetaRegistry.products.KITCHEN_CADDY_007F_0}
